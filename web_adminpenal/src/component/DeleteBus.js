...
<h3 style={{color:'red',marginLeft:'400px',marginTop:'5px'}}>{this.state.searcherrormessage}</h3>
            ...
            <div className={Styles['user-profile']} style={{backgroundColor:'#97BC62FF',width:'550px',marginBottom:'35px',}} key={post.uid}>
...
<li>
    <div style={{marginLeft:'200px'}}><span  style={{color:'#fff'}}><a onClick={(e)=>this.deletebus(post.uid,e)}>Delete</a></span></div>
</li>
</ul>
</div>
