...
import Footer from './Footer'
 class ShowUnassignBus extends Component {
  constructor(props)
  {
    super(props)
    this.state={
...
<h5 style={{color:'red',marginLeft:'400px',marginTop:'5px'}}>{this.state.searcherrormessage}</h5>
            ...
            <div className={Styles['user-profile']} style={{backgroundColor:'#97BC62FF',width:'550px',marginBottom:'40px'}}key={post.uid}> 
...
export default ShowUnassignBus
